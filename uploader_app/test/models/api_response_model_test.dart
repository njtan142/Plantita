...
import 'package:uploader_app/models/user_service_models.dart';
...
void main() {
  group('ApiResponse Tests', () {
    ...
    test('ApiResponse.fromJson creates success response from JSON', () {
      ...
      final response = ApiResponse.fromJson(json, (data) => UserModel.fromMap(data));
  ...
  group('PaginatedResponse Tests', () {
    test('PaginatedResponse.fromJson creates PaginatedResponse correctly', () {
      ...
      final response = PaginatedResponse.fromJson(json, (userJson) => UserModel.fromMap(userJson));

      expect(response.success, true);
      expect(response.items, hasLength(2));
      expect(response.items[0], isA<UserModel>());
