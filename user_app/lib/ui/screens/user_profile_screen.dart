                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 10),
                        Text(
                            'Total Reels: ${user.totalReelsUploaded} | Total Timelapses: ${user.totalTimelapsesUploaded}'),
                        const SizedBox(height: 10),
                        Text(
                            'Total Likes: ${user.totalLikesReceived} | Total Comments: ${user.totalCommentsReceived} | Total Shares: ${user.totalSharesReceived}'),
                        const SizedBox(height: 10),
