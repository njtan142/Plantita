...
export { default as mediaServiceDefault } from './mediaService';
export { default as authServiceDefault } from './authService';
export { default as dashboardServiceDefault } from './dashboardService';
export { default as analyticsServiceDefault } from './analyticsService';
...
export { default as communicationServiceDefault } from './communicationService';